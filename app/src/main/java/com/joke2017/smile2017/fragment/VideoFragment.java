...
public class VideoFragment extends BaseFragment implements BaseQuickAdapter.RequestLoadMoreListener {
    ...
    protected void initView(View view, Bundle savedInstanceState) {
        mIntent = new Intent();
        mTabFragmentRecyclerView = view.findViewById(R.id.tab_fragment_recycler_view_video);
        mSwipeRefresh = view.findViewById(R.id.swipe_refresh_video);
    ...
    public void initData() {
        ...
        long createTime = 0;
       String mChannelUrl = Urls.INFORMATION_DATA + "?" + "app_id=" + index + "&" +"c=0&"+
                "cid=" + 2 ;
