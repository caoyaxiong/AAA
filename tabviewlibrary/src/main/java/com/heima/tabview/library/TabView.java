...
public class TabView extends RelativeLayout {
    ...
    private List<String>  unSelectedUrllist;
    ...
    private void initTabChildView() {
        ...
        unSelectedUrllist=new ArrayList<>();
...
//                imageview.setImageResource();
                Glide.with(getContext()).load("https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1506677208&di=45c05a83f241bb4be8369e7d6ede6b0b&imgtype=jpg&er=1&src=http%3A%2F%2Fwww.th7.cn%2Fd%2Ffile%2Fp%2F2012%2F10%2F22%2F8001243a3c13634d567774793305c6db.png").into(imageview);
//                imageview.setImageResource(t.getImageViewUnSelIcon());
                unselectedIconList.add(t.getImageViewUnSelIcon());
                unSelectedUrllist.add(t.getImageViewUnSelUrl());
                ...
                if (mTabViewDefaultPosition >= mTabViewChildList.size()) {
                    if (i == 0) {
                        Glide.with(getContext()).load(unSelectedUrllist.get(i)).into(imageview);
...
//                        imageview.setImageResource(t.getImageViewSelIcon());
                ...
                tabChild.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View view) {
                        reSetAll();
                        Glide.with(getContext()).load(t.getImageViewSelUrl()).into(imageview);
//                        imageview.setImageResource(t.getImageViewSelIcon());
                        textview.setText(t.getTextViewText());
                        textview.setTextColor(mTextViewSelColor);
    ...
    private void reSetAll() {
        for (int i = 0; i < tabview.getChildCount(); i++) {
            ...
            for (int j = 0; j < tabChild.getChildCount(); j++) {
               ...
               Glide.with(getContext()).load(unSelectedUrllist.get(i)).into(iv);
